...
class Student
  ...
  #  with DB[:conn]
      ...
      # the attributes of our individual students: an id (which is the primary key), the name and the grade.
    ...
    # execution of a SQL query. We can anticipate that this 
    # array will contain three elements in this order: the id, name and grade 
    # of a student.
    ...
    # It queries the database table for a record that has a name 
    # of the name passed in as an argument. Then it uses the 
    # #new_from_db method to instantiate a Student object with the 
